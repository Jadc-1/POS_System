...
def inventory_app(parent):
    ...
    choose_category = CTkComboBox(query_frame, values = products_management.list_categorys_name(), text_color="#5E5E5E", font = ("Verdana", 13, "bold"), fg_color="white", button_color="white", button_hover_color="#BCBCBC", corner_radius= 10, dropdown_fg_color="white", dropdown_text_color="#5E5E5E", dropdown_font=("Verdana", 13, "bold"), border_width=0)
    choose_category.pack(padx = (225,0), pady=(9,7), side="left", fill="y")
    choose_category.set("Categorys")
    category_search = CTkButton(query_frame, corner_radius=10, width = 40, anchor="w", text="", fg_color="#57C590", hover_color="#49A578", image=search_image, command=search_category)
    category_search.pack_propagate(0)
    category_search.pack(pady=(9,7), padx=(3,0), fill = "y", side="left", anchor="center")
